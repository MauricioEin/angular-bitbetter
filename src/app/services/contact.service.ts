...
import { Observable, BehaviorSubject, of, throwError, observable, lastValueFrom } from 'rxjs';
...
export class ContactService {
    ...
    private _contact$ = new BehaviorSubject<Contact>(this.getEmptyContact())
    ...
    public getContactById(id: string): Observable<Contact> {
        ...
        // if (contact) this._contact$.next(contact)
        //return an observable
        contact ? this._contact$.next(contact) : throwError(() => `Contact id ${id} not found!`)
